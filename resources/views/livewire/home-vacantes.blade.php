        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white shadow-sm rounded-lg p-6 divide-y divide-gray-200">
                @forelse ($vacantes as $vacante)
                    <div class="md:flex md:justify-between text-gray-600 py-5">
                        <div class="md:flex-1">
                        ...
                        <div class="mt-5 md:mt-0">
                            <a class="p-0 md:p-3 text-sm uppercase font-bold text-gray  hover:text-blue-600 transition-colors mt-10 text-center"
